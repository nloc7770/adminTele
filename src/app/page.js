...
const Dashboard = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col justify-center items-center overflow-scroll bg-white">
      {contextHolder}
      <div className="w-full block md:flex md:justify-end p-5 z-50 fixed bg-white top-0">
        <div
      ...
      <div className="w-full h-full  md:flex flex-col justify-center items-center mt-[250px] ">
